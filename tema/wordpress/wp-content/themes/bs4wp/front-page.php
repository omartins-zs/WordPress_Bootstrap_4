    ...
    <div class="col mb-5">
        ...
        <div id="carouselBSWP" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <?php if ($my_query_banner->have_posts()) : $banner = $banners[0];
                    $c = 0;
            ...
            <a href="carouselBSWP" class="carousel-control-prev" role="button" data-slide="prev"><span class="carousel-control-prev-icon"></span>
                <span class="sr-only">Anteiror</span></a>
            <a href="carouselBSWP" class="carousel-control-next" role="button" data-slide="next"><span class="carousel-control-next-icon"></span>
